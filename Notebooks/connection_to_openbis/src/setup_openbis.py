...
if __name__ == "__main__":
    ...
    parser.add_argument('-u', '--openbis_token', type=str, help='OpenBIS User', default = '$pat-admin-250730144021175x3FD2A253AF7021A2987C210DF4113E32')
    parser.add_argument('-p', '--config_filepath', type=str, 
                        help='File that contains the spaces, projects, and collections configuration', 
                        default = "/home/jovyan/aiida-openbis/Notebooks/scripts/collections_config.json")

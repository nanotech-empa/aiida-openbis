...
def create_sxm_dataset(openbis, experiment, file_path, sample=None):
    ...
    inputs = [
        ...
        imaging.ImagingDataSetControl('X-axis', "Range", values_range=["0", str(img.get_param('scan_range')[0] * 10**9), "0.01"]),
        imaging.ImagingDataSetControl('Y-axis', "Range", values_range=["0", str(img.get_param('scan_range')[1] * 10**9), "0.01"]),

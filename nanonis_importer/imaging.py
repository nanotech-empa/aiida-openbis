...
class ImagingDataSetPreview(AbstractImagingRequest):
    ...
    def __init__(
        self, preview_format, config=None, metadata=None, index=0, comment="", tags=[]
    ):
...
class ImagingDataSetControlVisibility(AbstractImagingClass):
    ...
    def __init__(
        self, label: str, values: list[str], values_range: list[str], unit: str = None
    ):
...
class ImagingDataSetControl(AbstractImagingClass):
    ...
    def __init__(
        ...
        unit: str = None,
        values_range: list[str] = None,
        multiselect: bool = None,
        playable: bool = False,
        speeds: list[int] = None,
        visibility: list[ImagingDataSetControlVisibility] = None,
        metadata: dict = None,
    ):
...
class ImagingDataSetConfig(AbstractImagingClass):
    ...
    def __init__(
        ...
        playable: bool,
        speeds: list[int] = None,
        exports: list[ImagingDataSetControl] = None,
        inputs: list[ImagingDataSetControl] = None,
        metadata: dict = None,
    ):
    ...
    def from_dict(cls, data):
        ...
        for prop in cls.__annotations__.keys():
            ...
            if prop in ["exports", "inputs"] and attribute is not None:
                attribute = [
                    ImagingDataSetControl.from_dict(control) for control in attribute
                ]
...
class ImagingControl:
    ...
    def _execute_custom_dss_service(self, parameters):
        ...
        request = {
            ...
            "params": [self._openbis.token, service_id, options],
        }
    ...
    def _get_export_url(
        ...
        service_response = self._openbis.execute_custom_dss_service(
    ...
    def multi_export_download(
        self, exports: list[ImagingDataSetMultiExport], directory_path=""
    ):
    ...
    def create_imaging_dataset(
        ...
        dataset = self._openbis.new_dataset(
            dataset_type, experiment=experiment, sample=sample, files=files, props=props
        )
        return dataset.save()
